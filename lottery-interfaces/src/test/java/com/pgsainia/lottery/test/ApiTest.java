...
public class ApiTest {
    ...
    public void init() {
        ...
        award_01.setAwardContent("请联系活动组织者 nini");
        ...
        award_02.setAwardContent("请联系活动组织者 nini");
        ...
        award_03.setAwardContent("请联系活动组织者 nini");
        ...
        award_04.setAwardContent("请联系活动组织者 nini");
        ...
        award_05.setAwardContent("请联系活动组织者 nini");
    ...
    public void testAlterStatus() {
        logger.info("提交审核：{}", JSON.toJSONString(stateHandler.arraignment(100001L, Constants.ActivityState.EDIT)));
        logger.info("审核通过：{}", JSON.toJSONString(stateHandler.checkPass(100001L, Constants.ActivityState.ARRAIGNMENT)));
        logger.info("进行活动：{}", JSON.toJSONString(stateHandler.doing(100001L, Constants.ActivityState.PASS)));
        logger.info("二次提审：{}", JSON.toJSONString(stateHandler.checkPass(100001L, Constants.ActivityState.EDIT)));
    }
