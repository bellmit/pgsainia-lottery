...
public class RedeemCodeGoods extends DistributionBase implements IDistributionGoods {
    ...
    private final Logger logger = LoggerFactory.getLogger(RedeemCodeGoods.class);

    @Override
    public DistributionRes doDistribution(GoodsReq goodsReq) {
        logger.info("模拟兑奖码类发放接口，uId：{}，awardCount：{}", goodsReq.getuId(), goodsReq.getAwardContent());
        // 更新用户领奖结果
